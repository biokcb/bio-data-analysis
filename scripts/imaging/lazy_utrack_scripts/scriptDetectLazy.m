...
% 
% Modified 2013 for use with forthelazier.m by Kristen Brown
%
...
movieParam.imageDir = a; %directory where images are
movieParam.filenameBase = b; %image file name base
movieParam.firstImageNum = f; %number of first image in movie
movieParam.lastImageNum = g; %number of last image in movie
movieParam.digits4Enum = h; %number of digits used for frame enumeration (1-4).
...
detectionParam.alphaLocMax = 0.001;
...
saveResults.dir = asave; %directory where to save input and output
saveResults.filename = c; %name of file where input and output are saved
